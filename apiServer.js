...
mongoose.connect('mongodb://testUser:test@ds021711.mlab.com:21711/bookshop',{useMongoClient: true});
...
app.post('/books', function(req, res){
	...
	Books.create(book, function(err, books){
		if(err){
			console.log("#POST BOOK ERROR: ", err);
		}
		res.json(books);
	})
});
...
app.put('/books/:_id', function(req, res){
	...
	//if the field not exist $set will set a new field
	var update = {
		'$set':{
			title:book.title,
